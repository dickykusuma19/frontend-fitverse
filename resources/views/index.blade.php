...
<head>
    ...
    <!-- Favicon -->
    <link href="/assets/img/heart-rate.ico" rel="icon">
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0" id="home">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <h1 class="m-0"></i>FIT<span style=color:#0277bd><i class="fas fa-heartbeat"></span></i><span><font face="">VERSE</span></font></h1>
                ...
                <div class="container px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-8 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated slideInDown">The Revolutionary App That Helps To Control Your Own Fitness and Health</h1>
                            <p class="text-white pb-3 animated slideInDown">Based on our team member experience and also some people who are 
                                struggling with diet program. We are excited to tackle this problem because this problem looks easy to solve 
                                but it is not. At the first meeting we discussed the problem that we wanted to solve. We found some good ideas 
                                but that idea is not really impactful for some people. So we choose to come up with this project to help people 
                                who want to change their unhealthy lifestyle to be a good one.</p>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-4">#1 App For Your Health</h1>
                        <p class="mb-4">FitVerse have two main feature are Food Ingredient Nutritions Scanner and Exercise Scanner</p>
            ...
            <div class="container py-5 px-lg-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item bg-light rounded p-4">
                            <div class="d-inline-flex align-items-center justify-content-center bg-primary-gradient rounded-circle mb-4" style="width: 60px; height: 60px;">
                                <i class="fas fa-hamburger text-white fs-4"></i>
                            </div>
                            <h5 class="mb-3">Food Ingredient Nutritions Scanner</h5>
                            <p class="m-0">Main Feature</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="feature-item bg-light rounded p-4">
                            <div class="d-inline-flex align-items-center justify-content-center bg-secondary-gradient rounded-circle mb-4" style="width: 60px; height: 60px;">
                                <i class="	fas fa-running text-white fs-4"></i>
                            </div>
                            <h5 class="mb-3">Exercise Scanner</h5>
                            <p class="m-0">Main Feature</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="feature-item bg-light rounded p-4">
                            <div class="d-inline-flex align-items-center justify-content-center bg-primary-gradient rounded-circle mb-4" style="width: 60px; height: 60px;">
                                <i class="far fa-star text-white fs-4"></i>
                            </div>
                            <h5 class="mb-3">Data Add to Favorite</h5>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <h5 class="mb-3">Food & Fitness News</h5>
                            <p class="m-0">Under Development</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="feature-item bg-light rounded p-4">
                            <div class="d-inline-flex align-items-center justify-content-center bg-primary-gradient rounded-circle mb-4" style="width: 60px; height: 60px;">
                                <i class="fas fa-stopwatch text-white fs-4"></i>
                            </div>
                            <h5 class="mb-3">Calories Tracker</h5>
                            <p class="m-0">Under Development</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <h5 class="mb-3">Online Personal Trainer Class</h5>
                            <p class="m-0">Under Development</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-4">User Friendly interface And Very Easy To Use FitVerse App</h1>
                        <p class="mb-4"></p>
                        <p><i class="fa fa-check text-primary-gradient me-3"></i>Food and workout features are in the same app</p>
                        <p><i class="fa fa-check text-primary-gradient me-3"></i>Scanning feature is the main feature in this application</p>
                        <p class="mb-4"><i class="fa fa-check text-primary-gradient me-3"></i>Virtual coaching will be an incoming feature</p>
                        <!-- <a href="" class="btn btn-primary-gradient py-sm-3 px-4 px-sm-5 rounded-pill mt-3">Read More</a> -->
                    </div>
                    <div class="col-lg-4 d-flex justify-content-center justify-content-lg-end wow fadeInUp" data-wow-delay="0.3s">
                        <div class="owl-carousel screenshot-carousel">
                ...
                <div class="row gy-5 gx-4 justify-content-center">
                    <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                            ...
                            <h5 class="mt-4 mb-3">Open the app and login/sign up first</h5>
                            <p class="mb-0"></p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                            ...
                            <h5 class="mt-4 mb-3">Choose Scan Feature and take a picture of the object</h5>
                            <p class="mb-0"></p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                            ...
                            <h5 class="mt-4 mb-3">Wait for the recognition process then the result will displayed</h5>
                            <p class="mb-0"></p>
                        </div>
                    </div>
                </div>
    ...
    <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
        <div class="testimonial-item rounded p-4">
            <div class="d-flex align-items-center mb-4">
                <img class="img-fluid bg-white rounded flex-shrink-0 p-1" src="assets/img/testimonial-1.jpg" style="width: 85px; height: 85px;">
                <div class="ms-4">
        ...
        <div class="testimonial-item rounded p-4">
            <div class="d-flex align-items-center mb-4">
                <img class="img-fluid bg-white rounded flex-shrink-0 p-1" src="assets/img/testimonial-2.jpg" style="width: 85px; height: 85px;">
                <div class="ms-4">
                    <h5 class="mb-1">Client Name</h5>
                    <p class="mb-1">Profession</p>
                    <div>
        ...
        <div class="testimonial-item rounded p-4">
            <div class="d-flex align-items-center mb-4">
                <img class="img-fluid bg-white rounded flex-shrink-0 p-1" src="assets/img/testimonial-3.jpg" style="width: 85px; height: 85px;">
                <div class="ms-4">
                    <h5 class="mb-1">Client Name</h5>
                    <p class="mb-1">Profession</p>
                    <div>
        ...
        <div class="testimonial-item rounded p-4">
            <div class="d-flex align-items-center mb-4">
                <img class="img-fluid bg-white rounded flex-shrink-0 p-1" src="assets/img/testimonial-4.jpg" style="width: 85px; height: 85px;">
                <div class="ms-4">
                    <h5 class="mb-1">Client Name</h5>
                    <p class="mb-1">Profession</p>
                    <div>
		...
		<div class="container">
			...
			<div class="row justify-content-center text-center">
                ...
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="text-primary-gradient fw-medium">Team</h5>
			...
			<div class="row">
				<!-- Start Single Person -->
				<div class="col-xs-12 col-sm-6 col-md-4 wow fadeInUp" data-wow-delay="0.1s">
					<div class="single-person">
						...
						<div class="person-info">
							<h3 class="full-name">M. Hasyim Abdillah P.</h3>
							<span class="speciality">Machine Learning Path</span>
						</div>
					</div>
				</div>
				<!-- / End Single Person -->
				...
				<div class="col-xs-12 col-sm-6 col-md-4 wow fadeInUp">
					<div class="single-person">
						...
						<div class="person-info">
							<h3 class="full-name">Jiwa Sambhuwara</h3>
							<span class="speciality">Machine Learning Path</span>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 wow fadeInUp">
					<div class="single-person">
						...
						<div class="person-info">
							<h3 class="full-name">Anak Agung Gede Iswara Andika Parayana</h3>
							<span class="speciality">Mobile Development Path</span>
						</div>
					</div>
				</div>
				<!-- / End Single Person -->
				...
				<div class="col-xs-12 col-sm-6 col-md-4 wow fadeInUp">
					<div class="single-person">
						...
						<div class="person-info">
							<h3 class="full-name">Komang Andika Widiantara</h3>
							<span class="speciality">Mobile Development Path</span>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 wow fadeInUp">
					<div class="single-person">
						...
						<div class="person-info">
							<h3 class="full-name">Diky Wahyu Kusuma Budi</h3>
							<span class="speciality">Cloud Computing Path</span>
						</div>
					</div>
				</div>
				<!-- / End Single Person -->
				...
				<div class="col-xs-12 col-sm-6 col-md-4 wow fadeInUp">
					<div class="single-person">
						...
						<div class="person-info">
							<h3 class="full-name">Neysa Amelia Hutagalung</h3>
							<span class="speciality">Cloud Computing Path</span>
						</div>
					</div>
				</div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i>Denpasar, Bali</p>
                        <p><i class="fa fa-envelope me-3"></i>fitverse@fitverse.masuk.id</p>
                ...
                <div class="copyright">
                    <div class="row"> 
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0"> 
                            &copy; <a class="border-bottom" href="#">FitVerse 2022</a>, All Right Reserved. 
